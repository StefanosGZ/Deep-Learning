...
class CNN(nn.Module):
    ...
    def __init__(self, dropout_prob, no_maxpool=False):
        ...
        if not no_maxpool:
            ...
            # Convolution layer with 8 output channels, a kernel of size 3x3, stride of 1 and padding
            # Chosen to preserve original image size
            self.conv1 = nn.Conv2d(in_channels=1, out_channels=8, kernel_size=(3, 3), stride=1, padding="same")
            # Max pooling with kernel size 2x2 and stride of 2
            self.max_pool = nn.MaxPool2d(kernel_size=(2, 2), stride=2)
            # Convolution layer with 16 output channels, a kernel of size 3x3, stride 1 and padding zero
            self.conv2 = nn.Conv2d(in_channels=8, out_channels=16, kernel_size=(3, 3), stride=1, padding=0)
        else:
            # Implementation for Q2.2
            # Convolution layer with 8 output channels, a kernel of size 3x3, stride of 2 and padding of 1
            self.conv1 = nn.Conv2d(in_channels=1, out_channels=8, kernel_size=(3, 3), stride=2, padding=1)
            # Convolution layer with 16 output channels, a kernel of size 3x3, stride of 2 and padding of 0
